...
public class App 
{
    ...
    public void testFormSubmission() {
        // Valid input test
        testForm(driver, "Raj Ojha", "0654789562", "raj.ojha@Gmail.com", "This is a test message.");

        // Invalid input tests
        testForm(driver, "RAj123", "0654789562", "raj.ojha@Gmail.com", "This is a test message."); // Invalid name
        testForm(driver, "John Doe", "abc0654789562", "jraj.ojha@Gmail.com", "This is a test message."); // Invalid mobile number
        testForm(driver, "John Doe", "0654789562", "raj.ojha@Gmail.com", "This is a test message."); // Invalid email
        testForm(driver, "John Doe", "0654789562", "raj.ojha@Gmail.com", ""); // Invalid message
    }
